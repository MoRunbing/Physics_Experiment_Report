...
\begin{@twocolumnfalse}
	...
	\begin{center}%
		\begin{spacing}{2.0}
			{\LARGE\bfseries Experiment B12: The Design and Assembling of Temperature Sensor$^{*}$  }%
		\end{spacing}
	    \vskip 0.5em%
	    {\large
	    \lineskip .75em%
	    ...
	    \vskip 0.4em%
	    {\normalsize 1. School of Medicine, Sun Yat-sen University, Guangzhou  { \rm 510275}, China}
	\end{center}
	\begin{abstract}
...
\footnotetext[2]{作者简介：莫润冰，20980131；E-mail: \url{morb@mail2.sysu.edu.cn}}
